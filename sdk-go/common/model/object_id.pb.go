...
func (x *LatestMetricId) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LatestMetricId) ProtoMessage() {}

func (x *LatestMetricId) ProtoReflect() protoreflect.Message {
	mi := &file_object_id_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LatestMetricId.ProtoReflect.Descriptor instead.
func (*LatestMetricId) Descriptor() ([]byte, []int) {
	return file_object_id_proto_rawDescGZIP(), []int{17}
}

func (x *LatestMetricId) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_object_id_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x20, 0x0a, 0x0e, 0x4c,
	0x61, 0x74, 0x65, 0x73, 0x74, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x49, 0x64, 0x12, 0x0e, 0x0a,
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x42, 0x47, 0x0a,
...
var file_object_id_proto_goTypes = []interface{}{
	...
	(*LatestMetricId)(nil),        // 17: littlehorse.LatestMetricId

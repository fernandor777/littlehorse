...
type LatestMetric struct {
	...
	Id          *LatestMetricId        `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Value       int64                  `protobuf:"varint,2,opt,name=value,proto3" json:"value,omitempty"`
	WindowStart *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=window_start,json=windowStart,proto3" json:"window_start,omitempty"`
	WindowEnd   *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=window_end,json=windowEnd,proto3" json:"window_end,omitempty"`
}

func (x *LatestMetric) Reset() {
	*x = LatestMetric{}
	if protoimpl.UnsafeEnabled {
...
func (x *LatestMetric) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LatestMetric) ProtoMessage() {}

func (x *LatestMetric) ProtoReflect() protoreflect.Message {
	mi := &file_metrics_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LatestMetric.ProtoReflect.Descriptor instead.
func (*LatestMetric) Descriptor() ([]byte, []int) {
	return file_metrics_proto_rawDescGZIP(), []int{6}
}

func (x *LatestMetric) GetId() *LatestMetricId {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *LatestMetric) GetValue() int64 {
	if x != nil {
		return x.Value
	}
	return 0
...
func (x *LatestMetric) GetWindowStart() *timestamppb.Timestamp {
	if x != nil {
		return x.WindowStart
	}
	return nil
...
func (x *LatestMetric) GetWindowEnd() *timestamppb.Timestamp {
	if x != nil {
		return x.WindowEnd
	}
	return nil
...
var file_metrics_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x52, 0x09, 0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x45, 0x6e, 0x64, 0x22, 0xcb,
	0x01, 0x0a, 0x0c, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x12,
	0x2b, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x6c, 0x69,
	0x74, 0x74, 0x6c, 0x65, 0x68, 0x6f, 0x72, 0x73, 0x65, 0x2e, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74,
	0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x49, 0x64, 0x52, 0x02, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x12, 0x3d, 0x0a, 0x0c, 0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x5f, 0x73, 0x74, 0x61,
	...
	0x70, 0x52, 0x09, 0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x45, 0x6e, 0x64, 0x42, 0x47, 0x0a, 0x1f,
...
var file_metrics_proto_goTypes = []interface{}{
	...
	(*LatestMetric)(nil),             // 6: littlehorse.LatestMetric
	(*timestamppb.Timestamp)(nil),    // 7: google.protobuf.Timestamp
	(*TenantId)(nil),                 // 8: littlehorse.TenantId
	(*LatestMetricId)(nil),           // 9: littlehorse.LatestMetricId
}
var file_metrics_proto_depIdxs = []int32{
	1,  // 0: littlehorse.MonitorConfig.id:type_name -> littlehorse.MonitorConfigId
	7,  // 1: littlehorse.MonitorConfig.created_time:type_name -> google.protobuf.Timestamp
	8,  // 2: littlehorse.MonitorConfigId.tenant_id:type_name -> littlehorse.TenantId
	...
	7,  // 8: littlehorse.UsageMetric.window_start:type_name -> google.protobuf.Timestamp
	7,  // 9: littlehorse.UsageMetric.window_end:type_name -> google.protobuf.Timestamp
	9,  // 10: littlehorse.LatestMetric.id:type_name -> littlehorse.LatestMetricId
	7,  // 11: littlehorse.LatestMetric.window_start:type_name -> google.protobuf.Timestamp
	7,  // 12: littlehorse.LatestMetric.window_end:type_name -> google.protobuf.Timestamp
